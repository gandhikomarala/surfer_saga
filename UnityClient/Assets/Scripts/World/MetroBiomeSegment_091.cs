namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #091
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_091 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_091";
        [SerializeField] private string stationName = "NCMAGLEV Station #091";
