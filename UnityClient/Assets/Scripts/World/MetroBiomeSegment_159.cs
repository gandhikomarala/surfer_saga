namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #159
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_159 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_159";
        [SerializeField] private string stationName = "NCMAGLEV Station #159";
