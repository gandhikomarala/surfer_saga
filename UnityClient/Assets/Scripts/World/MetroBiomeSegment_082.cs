namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #082
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_082 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_082";
        [SerializeField] private string stationName = "NCMAGLEV Station #082";
