namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #028
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_028 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_028";
        [SerializeField] private string stationName = "NCMAGLEV Station #028";
