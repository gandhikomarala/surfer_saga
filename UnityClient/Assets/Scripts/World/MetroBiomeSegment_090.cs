namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #090
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_090 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_090";
        [SerializeField] private string stationName = "NCMAGLEV Station #090";
