namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #085
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_085 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_085";
        [SerializeField] private string stationName = "NCMAGLEV Station #085";
