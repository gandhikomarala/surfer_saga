namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #146
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_146 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_146";
        [SerializeField] private string stationName = "NCMAGLEV Station #146";
