namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #067
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_067 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_067";
        [SerializeField] private string stationName = "NCMAGLEV Station #067";
