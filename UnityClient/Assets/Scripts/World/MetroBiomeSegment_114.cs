namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #114
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_114 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_114";
        [SerializeField] private string stationName = "NCMAGLEV Station #114";
