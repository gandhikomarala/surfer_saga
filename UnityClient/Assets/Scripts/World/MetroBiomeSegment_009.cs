namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #009
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_009 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_009";
        [SerializeField] private string stationName = "NCMAGLEV Station #009";
