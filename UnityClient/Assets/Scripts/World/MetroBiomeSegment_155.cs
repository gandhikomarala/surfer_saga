namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #155
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_155 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_155";
        [SerializeField] private string stationName = "NCMAGLEV Station #155";
