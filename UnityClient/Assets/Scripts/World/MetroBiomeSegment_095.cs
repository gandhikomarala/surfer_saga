namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #095
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_095 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_095";
        [SerializeField] private string stationName = "NCMAGLEV Station #095";
