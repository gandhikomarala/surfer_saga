namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #094
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_094 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_094";
        [SerializeField] private string stationName = "NCMAGLEV Station #094";
