namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #058
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_058 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_058";
        [SerializeField] private string stationName = "NCMAGLEV Station #058";
