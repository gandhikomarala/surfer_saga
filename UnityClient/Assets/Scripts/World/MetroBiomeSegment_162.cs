namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #162
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_162 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_162";
        [SerializeField] private string stationName = "NCMAGLEV Station #162";
