namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #133
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_133 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_133";
        [SerializeField] private string stationName = "NCMAGLEV Station #133";
