namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #138
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_138 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_138";
        [SerializeField] private string stationName = "NCMAGLEV Station #138";
