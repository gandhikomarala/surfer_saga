namespace MetroRush.World
{
    ...
    /// <summary>
    /// Procedural Metro Biome Segment #072
    /// Generates metro stations, neon city corridors, underground tunnels, industrial districts, and sky rails.
    /// </summary>
    public class MetroBiomeSegment_072 : MonoBehaviour
    {
        [Header("Biome Properties")]
        [SerializeField] private string biomeId = "METRO_BIOME_072";
        [SerializeField] private string stationName = "NCMAGLEV Station #072";
