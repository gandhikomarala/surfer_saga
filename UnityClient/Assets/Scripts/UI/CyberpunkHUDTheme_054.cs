namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #054
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_054", menuName = "MetroRush/UI/HUD Theme #054")]
    public class CyberpunkHUDTheme_054 : ScriptableObject
    {
