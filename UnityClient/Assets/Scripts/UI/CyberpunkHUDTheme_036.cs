namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #036
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_036", menuName = "MetroRush/UI/HUD Theme #036")]
    public class CyberpunkHUDTheme_036 : ScriptableObject
    {
        [Header("HUD Color Palette")]
        [SerializeField] private string themeId = "HUD_THEME_036";
