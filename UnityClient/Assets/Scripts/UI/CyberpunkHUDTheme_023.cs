namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #023
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_023", menuName = "MetroRush/UI/HUD Theme #023")]
    public class CyberpunkHUDTheme_023 : ScriptableObject
    {
