namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #080
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_080", menuName = "MetroRush/UI/HUD Theme #080")]
    public class CyberpunkHUDTheme_080 : ScriptableObject
    {
