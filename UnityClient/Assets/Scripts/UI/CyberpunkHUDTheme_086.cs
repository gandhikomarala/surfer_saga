namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #086
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_086", menuName = "MetroRush/UI/HUD Theme #086")]
    public class CyberpunkHUDTheme_086 : ScriptableObject
    {
        [Header("HUD Color Palette")]
        [SerializeField] private string themeId = "HUD_THEME_086";
