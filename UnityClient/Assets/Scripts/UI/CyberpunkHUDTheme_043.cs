namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #043
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_043", menuName = "MetroRush/UI/HUD Theme #043")]
    public class CyberpunkHUDTheme_043 : ScriptableObject
    {
