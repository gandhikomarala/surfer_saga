namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #085
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_085", menuName = "MetroRush/UI/HUD Theme #085")]
    public class CyberpunkHUDTheme_085 : ScriptableObject
    {
