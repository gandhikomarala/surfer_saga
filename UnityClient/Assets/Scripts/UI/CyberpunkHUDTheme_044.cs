namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #044
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_044", menuName = "MetroRush/UI/HUD Theme #044")]
    public class CyberpunkHUDTheme_044 : ScriptableObject
    {
