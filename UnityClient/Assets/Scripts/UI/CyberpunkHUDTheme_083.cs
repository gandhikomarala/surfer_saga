namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #083
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_083", menuName = "MetroRush/UI/HUD Theme #083")]
    public class CyberpunkHUDTheme_083 : ScriptableObject
    {
