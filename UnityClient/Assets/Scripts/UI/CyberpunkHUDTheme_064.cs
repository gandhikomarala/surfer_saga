namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #064
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_064", menuName = "MetroRush/UI/HUD Theme #064")]
    public class CyberpunkHUDTheme_064 : ScriptableObject
    {
