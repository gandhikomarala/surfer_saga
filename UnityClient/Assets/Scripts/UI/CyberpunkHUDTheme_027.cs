namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #027
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_027", menuName = "MetroRush/UI/HUD Theme #027")]
    public class CyberpunkHUDTheme_027 : ScriptableObject
    {
