namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #093
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_093", menuName = "MetroRush/UI/HUD Theme #093")]
    public class CyberpunkHUDTheme_093 : ScriptableObject
    {
