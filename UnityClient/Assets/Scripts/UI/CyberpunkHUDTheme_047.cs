namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #047
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_047", menuName = "MetroRush/UI/HUD Theme #047")]
    public class CyberpunkHUDTheme_047 : ScriptableObject
    {
