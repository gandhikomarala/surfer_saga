namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #062
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_062", menuName = "MetroRush/UI/HUD Theme #062")]
    public class CyberpunkHUDTheme_062 : ScriptableObject
    {
