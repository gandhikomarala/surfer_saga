namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #078
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_078", menuName = "MetroRush/UI/HUD Theme #078")]
    public class CyberpunkHUDTheme_078 : ScriptableObject
    {
