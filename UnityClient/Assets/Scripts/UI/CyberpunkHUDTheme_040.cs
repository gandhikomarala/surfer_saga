namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #040
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_040", menuName = "MetroRush/UI/HUD Theme #040")]
    public class CyberpunkHUDTheme_040 : ScriptableObject
    {
        [Header("HUD Color Palette")]
        [SerializeField] private string themeId = "HUD_THEME_040";
