namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #051
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_051", menuName = "MetroRush/UI/HUD Theme #051")]
    public class CyberpunkHUDTheme_051 : ScriptableObject
    {
