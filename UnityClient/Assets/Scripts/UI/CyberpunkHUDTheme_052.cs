namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #052
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_052", menuName = "MetroRush/UI/HUD Theme #052")]
    public class CyberpunkHUDTheme_052 : ScriptableObject
    {
