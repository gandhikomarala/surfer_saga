namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #019
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_019", menuName = "MetroRush/UI/HUD Theme #019")]
    public class CyberpunkHUDTheme_019 : ScriptableObject
    {
