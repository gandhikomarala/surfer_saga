namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #094
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_094", menuName = "MetroRush/UI/HUD Theme #094")]
    public class CyberpunkHUDTheme_094 : ScriptableObject
    {
