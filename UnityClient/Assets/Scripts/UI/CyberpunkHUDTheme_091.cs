namespace MetroRush.UI
{
    ...
    /// <summary>
    /// Cyberpunk HUD Visual Theme & CRT Post-Processing #091
    /// Renders holographic speedometers, token multipliers, scanlines, and chromatic aberration.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberpunkHUDTheme_091", menuName = "MetroRush/UI/HUD Theme #091")]
    public class CyberpunkHUDTheme_091 : ScriptableObject
    {
