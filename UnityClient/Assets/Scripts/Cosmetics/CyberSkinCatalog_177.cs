namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #177
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_177", menuName = "MetroRush/Cosmetics/Skin #177")]
    public class CyberSkinCatalog_177 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_177";
        [SerializeField] private string courierName = "Courier Outfit #177";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (177 * 40);
        [SerializeField] private int requiredDistanceMeters = 177 * 900;
