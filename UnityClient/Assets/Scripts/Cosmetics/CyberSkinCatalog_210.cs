namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #210
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_210", menuName = "MetroRush/Cosmetics/Skin #210")]
    public class CyberSkinCatalog_210 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_210";
        [SerializeField] private string courierName = "Courier Outfit #210";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (210 * 40);
        [SerializeField] private int requiredDistanceMeters = 210 * 900;
