namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #119
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_119", menuName = "MetroRush/Cosmetics/Skin #119")]
    public class CyberSkinCatalog_119 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_119";
        [SerializeField] private string courierName = "Courier Outfit #119";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (119 * 40);
        [SerializeField] private int requiredDistanceMeters = 119 * 900;
