namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #118
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_118", menuName = "MetroRush/Cosmetics/Skin #118")]
    public class CyberSkinCatalog_118 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_118";
        [SerializeField] private string courierName = "Courier Outfit #118";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (118 * 40);
        [SerializeField] private int requiredDistanceMeters = 118 * 900;
