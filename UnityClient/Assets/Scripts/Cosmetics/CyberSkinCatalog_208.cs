namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #208
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_208", menuName = "MetroRush/Cosmetics/Skin #208")]
    public class CyberSkinCatalog_208 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_208";
        [SerializeField] private string courierName = "Courier Outfit #208";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (208 * 40);
        [SerializeField] private int requiredDistanceMeters = 208 * 900;
