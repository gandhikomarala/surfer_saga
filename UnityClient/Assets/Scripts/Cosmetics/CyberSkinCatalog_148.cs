namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #148
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_148", menuName = "MetroRush/Cosmetics/Skin #148")]
    public class CyberSkinCatalog_148 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_148";
        [SerializeField] private string courierName = "Courier Outfit #148";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (148 * 40);
        [SerializeField] private int requiredDistanceMeters = 148 * 900;
