namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #108
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_108", menuName = "MetroRush/Cosmetics/Skin #108")]
    public class CyberSkinCatalog_108 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_108";
        [SerializeField] private string courierName = "Courier Outfit #108";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (108 * 40);
        [SerializeField] private int requiredDistanceMeters = 108 * 900;
