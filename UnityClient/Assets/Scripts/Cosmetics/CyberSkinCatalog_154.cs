namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #154
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_154", menuName = "MetroRush/Cosmetics/Skin #154")]
    public class CyberSkinCatalog_154 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_154";
        [SerializeField] private string courierName = "Courier Outfit #154";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (154 * 40);
        [SerializeField] private int requiredDistanceMeters = 154 * 900;
