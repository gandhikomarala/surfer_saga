namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #179
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_179", menuName = "MetroRush/Cosmetics/Skin #179")]
    public class CyberSkinCatalog_179 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_179";
        [SerializeField] private string courierName = "Courier Outfit #179";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (179 * 40);
        [SerializeField] private int requiredDistanceMeters = 179 * 900;
