namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #134
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_134", menuName = "MetroRush/Cosmetics/Skin #134")]
    public class CyberSkinCatalog_134 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_134";
        [SerializeField] private string courierName = "Courier Outfit #134";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (134 * 40);
        [SerializeField] private int requiredDistanceMeters = 134 * 900;
