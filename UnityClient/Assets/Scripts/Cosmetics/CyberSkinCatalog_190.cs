namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #190
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_190", menuName = "MetroRush/Cosmetics/Skin #190")]
    public class CyberSkinCatalog_190 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_190";
        [SerializeField] private string courierName = "Courier Outfit #190";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (190 * 40);
        [SerializeField] private int requiredDistanceMeters = 190 * 900;
