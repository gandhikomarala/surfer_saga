namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #051
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_051", menuName = "MetroRush/Cosmetics/Skin #051")]
    public class CyberSkinCatalog_051 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_051";
        [SerializeField] private string courierName = "Courier Outfit #051";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (51 * 40);
        [SerializeField] private int requiredDistanceMeters = 51 * 900;
