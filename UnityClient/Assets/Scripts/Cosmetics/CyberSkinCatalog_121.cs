namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #121
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_121", menuName = "MetroRush/Cosmetics/Skin #121")]
    public class CyberSkinCatalog_121 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_121";
        [SerializeField] private string courierName = "Courier Outfit #121";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (121 * 40);
        [SerializeField] private int requiredDistanceMeters = 121 * 900;
