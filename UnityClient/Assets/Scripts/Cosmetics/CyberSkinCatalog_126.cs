namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #126
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_126", menuName = "MetroRush/Cosmetics/Skin #126")]
    public class CyberSkinCatalog_126 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_126";
        [SerializeField] private string courierName = "Courier Outfit #126";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (126 * 40);
        [SerializeField] private int requiredDistanceMeters = 126 * 900;
