namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #107
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_107", menuName = "MetroRush/Cosmetics/Skin #107")]
    public class CyberSkinCatalog_107 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_107";
        [SerializeField] private string courierName = "Courier Outfit #107";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (107 * 40);
        [SerializeField] private int requiredDistanceMeters = 107 * 900;
