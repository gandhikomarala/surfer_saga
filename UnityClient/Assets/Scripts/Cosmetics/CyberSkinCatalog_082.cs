namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #082
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_082", menuName = "MetroRush/Cosmetics/Skin #082")]
    public class CyberSkinCatalog_082 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_082";
        [SerializeField] private string courierName = "Courier Outfit #082";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (82 * 40);
        [SerializeField] private int requiredDistanceMeters = 82 * 900;
