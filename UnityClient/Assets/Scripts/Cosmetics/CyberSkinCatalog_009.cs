namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #009
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_009", menuName = "MetroRush/Cosmetics/Skin #009")]
    public class CyberSkinCatalog_009 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_009";
        [SerializeField] private string courierName = "Courier Outfit #009";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (9 * 40);
        [SerializeField] private int requiredDistanceMeters = 9 * 900;
