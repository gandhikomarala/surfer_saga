namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #238
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_238", menuName = "MetroRush/Cosmetics/Skin #238")]
    public class CyberSkinCatalog_238 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_238";
        [SerializeField] private string courierName = "Courier Outfit #238";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (238 * 40);
        [SerializeField] private int requiredDistanceMeters = 238 * 900;
