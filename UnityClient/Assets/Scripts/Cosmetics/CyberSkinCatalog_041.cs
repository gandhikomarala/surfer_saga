namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #041
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_041", menuName = "MetroRush/Cosmetics/Skin #041")]
    public class CyberSkinCatalog_041 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_041";
        [SerializeField] private string courierName = "Courier Outfit #041";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (41 * 40);
        [SerializeField] private int requiredDistanceMeters = 41 * 900;
