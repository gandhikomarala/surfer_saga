namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #215
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_215", menuName = "MetroRush/Cosmetics/Skin #215")]
    public class CyberSkinCatalog_215 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_215";
        [SerializeField] private string courierName = "Courier Outfit #215";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (215 * 40);
        [SerializeField] private int requiredDistanceMeters = 215 * 900;
