namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #018
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_018", menuName = "MetroRush/Cosmetics/Skin #018")]
    public class CyberSkinCatalog_018 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_018";
        [SerializeField] private string courierName = "Courier Outfit #018";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (18 * 40);
        [SerializeField] private int requiredDistanceMeters = 18 * 900;
