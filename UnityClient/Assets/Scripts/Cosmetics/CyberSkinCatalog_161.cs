namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #161
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_161", menuName = "MetroRush/Cosmetics/Skin #161")]
    public class CyberSkinCatalog_161 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_161";
        [SerializeField] private string courierName = "Courier Outfit #161";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (161 * 40);
        [SerializeField] private int requiredDistanceMeters = 161 * 900;
