namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #053
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_053", menuName = "MetroRush/Cosmetics/Skin #053")]
    public class CyberSkinCatalog_053 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_053";
        [SerializeField] private string courierName = "Courier Outfit #053";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (53 * 40);
        [SerializeField] private int requiredDistanceMeters = 53 * 900;
