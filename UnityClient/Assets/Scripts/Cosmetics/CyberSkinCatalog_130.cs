namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #130
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_130", menuName = "MetroRush/Cosmetics/Skin #130")]
    public class CyberSkinCatalog_130 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_130";
        [SerializeField] private string courierName = "Courier Outfit #130";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (130 * 40);
        [SerializeField] private int requiredDistanceMeters = 130 * 900;
