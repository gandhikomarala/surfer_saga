namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #008
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_008", menuName = "MetroRush/Cosmetics/Skin #008")]
    public class CyberSkinCatalog_008 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_008";
        [SerializeField] private string courierName = "Courier Outfit #008";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (8 * 40);
        [SerializeField] private int requiredDistanceMeters = 8 * 900;
