namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #250
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_250", menuName = "MetroRush/Cosmetics/Skin #250")]
    public class CyberSkinCatalog_250 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_250";
        [SerializeField] private string courierName = "Courier Outfit #250";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (250 * 40);
        [SerializeField] private int requiredDistanceMeters = 250 * 900;
