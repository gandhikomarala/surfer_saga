namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #214
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_214", menuName = "MetroRush/Cosmetics/Skin #214")]
    public class CyberSkinCatalog_214 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_214";
        [SerializeField] private string courierName = "Courier Outfit #214";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (214 * 40);
        [SerializeField] private int requiredDistanceMeters = 214 * 900;
