namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #038
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_038", menuName = "MetroRush/Cosmetics/Skin #038")]
    public class CyberSkinCatalog_038 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_038";
        [SerializeField] private string courierName = "Courier Outfit #038";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (38 * 40);
        [SerializeField] private int requiredDistanceMeters = 38 * 900;
