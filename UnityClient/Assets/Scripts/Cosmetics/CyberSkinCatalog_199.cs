namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #199
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_199", menuName = "MetroRush/Cosmetics/Skin #199")]
    public class CyberSkinCatalog_199 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_199";
        [SerializeField] private string courierName = "Courier Outfit #199";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (199 * 40);
        [SerializeField] private int requiredDistanceMeters = 199 * 900;
