namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #163
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_163", menuName = "MetroRush/Cosmetics/Skin #163")]
    public class CyberSkinCatalog_163 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_163";
        [SerializeField] private string courierName = "Courier Outfit #163";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (163 * 40);
        [SerializeField] private int requiredDistanceMeters = 163 * 900;
