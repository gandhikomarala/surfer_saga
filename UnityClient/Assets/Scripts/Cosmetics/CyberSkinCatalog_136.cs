namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #136
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_136", menuName = "MetroRush/Cosmetics/Skin #136")]
    public class CyberSkinCatalog_136 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_136";
        [SerializeField] private string courierName = "Courier Outfit #136";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (136 * 40);
        [SerializeField] private int requiredDistanceMeters = 136 * 900;
