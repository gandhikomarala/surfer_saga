namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #061
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_061", menuName = "MetroRush/Cosmetics/Skin #061")]
    public class CyberSkinCatalog_061 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_061";
        [SerializeField] private string courierName = "Courier Outfit #061";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (61 * 40);
        [SerializeField] private int requiredDistanceMeters = 61 * 900;
