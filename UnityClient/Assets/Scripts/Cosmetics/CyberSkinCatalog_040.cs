namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #040
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_040", menuName = "MetroRush/Cosmetics/Skin #040")]
    public class CyberSkinCatalog_040 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_040";
        [SerializeField] private string courierName = "Courier Outfit #040";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (40 * 40);
        [SerializeField] private int requiredDistanceMeters = 40 * 900;
