namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #159
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_159", menuName = "MetroRush/Cosmetics/Skin #159")]
    public class CyberSkinCatalog_159 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_159";
        [SerializeField] private string courierName = "Courier Outfit #159";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (159 * 40);
        [SerializeField] private int requiredDistanceMeters = 159 * 900;
