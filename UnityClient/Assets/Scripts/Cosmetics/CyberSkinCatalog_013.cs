namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #013
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_013", menuName = "MetroRush/Cosmetics/Skin #013")]
    public class CyberSkinCatalog_013 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_013";
        [SerializeField] private string courierName = "Courier Outfit #013";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (13 * 40);
        [SerializeField] private int requiredDistanceMeters = 13 * 900;
