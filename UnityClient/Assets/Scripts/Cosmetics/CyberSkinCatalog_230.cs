namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #230
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_230", menuName = "MetroRush/Cosmetics/Skin #230")]
    public class CyberSkinCatalog_230 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_230";
        [SerializeField] private string courierName = "Courier Outfit #230";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (230 * 40);
        [SerializeField] private int requiredDistanceMeters = 230 * 900;
