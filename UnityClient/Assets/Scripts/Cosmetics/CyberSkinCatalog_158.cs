namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #158
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_158", menuName = "MetroRush/Cosmetics/Skin #158")]
    public class CyberSkinCatalog_158 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_158";
        [SerializeField] private string courierName = "Courier Outfit #158";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (158 * 40);
        [SerializeField] private int requiredDistanceMeters = 158 * 900;
