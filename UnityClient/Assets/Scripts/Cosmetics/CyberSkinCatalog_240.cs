namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #240
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_240", menuName = "MetroRush/Cosmetics/Skin #240")]
    public class CyberSkinCatalog_240 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_240";
        [SerializeField] private string courierName = "Courier Outfit #240";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (240 * 40);
        [SerializeField] private int requiredDistanceMeters = 240 * 900;
