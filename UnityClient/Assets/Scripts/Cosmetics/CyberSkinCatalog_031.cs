namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #031
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_031", menuName = "MetroRush/Cosmetics/Skin #031")]
    public class CyberSkinCatalog_031 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_031";
        [SerializeField] private string courierName = "Courier Outfit #031";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (31 * 40);
        [SerializeField] private int requiredDistanceMeters = 31 * 900;
