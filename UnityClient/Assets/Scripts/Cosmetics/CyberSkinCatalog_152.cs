namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #152
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_152", menuName = "MetroRush/Cosmetics/Skin #152")]
    public class CyberSkinCatalog_152 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_152";
        [SerializeField] private string courierName = "Courier Outfit #152";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (152 * 40);
        [SerializeField] private int requiredDistanceMeters = 152 * 900;
