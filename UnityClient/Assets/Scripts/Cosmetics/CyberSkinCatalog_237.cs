namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #237
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_237", menuName = "MetroRush/Cosmetics/Skin #237")]
    public class CyberSkinCatalog_237 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_237";
        [SerializeField] private string courierName = "Courier Outfit #237";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (237 * 40);
        [SerializeField] private int requiredDistanceMeters = 237 * 900;
