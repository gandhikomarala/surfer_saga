namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #102
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_102", menuName = "MetroRush/Cosmetics/Skin #102")]
    public class CyberSkinCatalog_102 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_102";
        [SerializeField] private string courierName = "Courier Outfit #102";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (102 * 40);
        [SerializeField] private int requiredDistanceMeters = 102 * 900;
