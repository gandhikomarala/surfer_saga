namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #221
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_221", menuName = "MetroRush/Cosmetics/Skin #221")]
    public class CyberSkinCatalog_221 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_221";
        [SerializeField] private string courierName = "Courier Outfit #221";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (221 * 40);
        [SerializeField] private int requiredDistanceMeters = 221 * 900;
