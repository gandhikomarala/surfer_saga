namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #090
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_090", menuName = "MetroRush/Cosmetics/Skin #090")]
    public class CyberSkinCatalog_090 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_090";
        [SerializeField] private string courierName = "Courier Outfit #090";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (90 * 40);
        [SerializeField] private int requiredDistanceMeters = 90 * 900;
