namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #155
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_155", menuName = "MetroRush/Cosmetics/Skin #155")]
    public class CyberSkinCatalog_155 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_155";
        [SerializeField] private string courierName = "Courier Outfit #155";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (155 * 40);
        [SerializeField] private int requiredDistanceMeters = 155 * 900;
