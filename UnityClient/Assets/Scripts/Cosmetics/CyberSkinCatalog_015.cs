namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #015
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_015", menuName = "MetroRush/Cosmetics/Skin #015")]
    public class CyberSkinCatalog_015 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_015";
        [SerializeField] private string courierName = "Courier Outfit #015";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (15 * 40);
        [SerializeField] private int requiredDistanceMeters = 15 * 900;
