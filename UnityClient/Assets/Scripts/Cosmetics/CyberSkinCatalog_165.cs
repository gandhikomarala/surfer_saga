namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #165
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_165", menuName = "MetroRush/Cosmetics/Skin #165")]
    public class CyberSkinCatalog_165 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_165";
        [SerializeField] private string courierName = "Courier Outfit #165";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (165 * 40);
        [SerializeField] private int requiredDistanceMeters = 165 * 900;
