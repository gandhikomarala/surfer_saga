namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #080
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_080", menuName = "MetroRush/Cosmetics/Skin #080")]
    public class CyberSkinCatalog_080 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_080";
        [SerializeField] private string courierName = "Courier Outfit #080";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (80 * 40);
        [SerializeField] private int requiredDistanceMeters = 80 * 900;
