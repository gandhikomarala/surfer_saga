namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #196
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_196", menuName = "MetroRush/Cosmetics/Skin #196")]
    public class CyberSkinCatalog_196 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_196";
        [SerializeField] private string courierName = "Courier Outfit #196";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (196 * 40);
        [SerializeField] private int requiredDistanceMeters = 196 * 900;
