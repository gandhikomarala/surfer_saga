namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #227
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_227", menuName = "MetroRush/Cosmetics/Skin #227")]
    public class CyberSkinCatalog_227 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_227";
        [SerializeField] private string courierName = "Courier Outfit #227";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (227 * 40);
        [SerializeField] private int requiredDistanceMeters = 227 * 900;
