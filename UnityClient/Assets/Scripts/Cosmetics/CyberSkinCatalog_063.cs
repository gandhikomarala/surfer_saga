namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #063
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_063", menuName = "MetroRush/Cosmetics/Skin #063")]
    public class CyberSkinCatalog_063 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_063";
        [SerializeField] private string courierName = "Courier Outfit #063";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (63 * 40);
        [SerializeField] private int requiredDistanceMeters = 63 * 900;
