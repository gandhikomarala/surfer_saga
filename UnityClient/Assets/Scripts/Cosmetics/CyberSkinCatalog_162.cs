namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #162
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_162", menuName = "MetroRush/Cosmetics/Skin #162")]
    public class CyberSkinCatalog_162 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_162";
        [SerializeField] private string courierName = "Courier Outfit #162";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (162 * 40);
        [SerializeField] private int requiredDistanceMeters = 162 * 900;
