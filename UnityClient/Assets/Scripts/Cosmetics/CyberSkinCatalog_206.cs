namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #206
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_206", menuName = "MetroRush/Cosmetics/Skin #206")]
    public class CyberSkinCatalog_206 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_206";
        [SerializeField] private string courierName = "Courier Outfit #206";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (206 * 40);
        [SerializeField] private int requiredDistanceMeters = 206 * 900;
