namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #021
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_021", menuName = "MetroRush/Cosmetics/Skin #021")]
    public class CyberSkinCatalog_021 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_021";
        [SerializeField] private string courierName = "Courier Outfit #021";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (21 * 40);
        [SerializeField] private int requiredDistanceMeters = 21 * 900;
