namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #140
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_140", menuName = "MetroRush/Cosmetics/Skin #140")]
    public class CyberSkinCatalog_140 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_140";
        [SerializeField] private string courierName = "Courier Outfit #140";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (140 * 40);
        [SerializeField] private int requiredDistanceMeters = 140 * 900;
