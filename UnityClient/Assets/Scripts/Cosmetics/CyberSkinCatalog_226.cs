namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #226
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_226", menuName = "MetroRush/Cosmetics/Skin #226")]
    public class CyberSkinCatalog_226 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_226";
        [SerializeField] private string courierName = "Courier Outfit #226";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (226 * 40);
        [SerializeField] private int requiredDistanceMeters = 226 * 900;
