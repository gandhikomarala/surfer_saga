namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #133
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_133", menuName = "MetroRush/Cosmetics/Skin #133")]
    public class CyberSkinCatalog_133 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_133";
        [SerializeField] private string courierName = "Courier Outfit #133";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (133 * 40);
        [SerializeField] private int requiredDistanceMeters = 133 * 900;
