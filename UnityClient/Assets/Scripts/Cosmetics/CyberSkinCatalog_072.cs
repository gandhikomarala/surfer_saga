namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #072
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_072", menuName = "MetroRush/Cosmetics/Skin #072")]
    public class CyberSkinCatalog_072 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_072";
        [SerializeField] private string courierName = "Courier Outfit #072";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (72 * 40);
        [SerializeField] private int requiredDistanceMeters = 72 * 900;
