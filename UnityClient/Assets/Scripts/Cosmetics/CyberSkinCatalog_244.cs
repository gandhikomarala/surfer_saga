namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #244
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_244", menuName = "MetroRush/Cosmetics/Skin #244")]
    public class CyberSkinCatalog_244 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_244";
        [SerializeField] private string courierName = "Courier Outfit #244";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (244 * 40);
        [SerializeField] private int requiredDistanceMeters = 244 * 900;
