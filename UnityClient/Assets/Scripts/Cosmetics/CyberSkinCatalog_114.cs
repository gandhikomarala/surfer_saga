namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #114
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_114", menuName = "MetroRush/Cosmetics/Skin #114")]
    public class CyberSkinCatalog_114 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_114";
        [SerializeField] private string courierName = "Courier Outfit #114";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (114 * 40);
        [SerializeField] private int requiredDistanceMeters = 114 * 900;
