namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #025
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_025", menuName = "MetroRush/Cosmetics/Skin #025")]
    public class CyberSkinCatalog_025 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_025";
        [SerializeField] private string courierName = "Courier Outfit #025";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (25 * 40);
        [SerializeField] private int requiredDistanceMeters = 25 * 900;
