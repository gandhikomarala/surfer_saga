namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #054
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_054", menuName = "MetroRush/Cosmetics/Skin #054")]
    public class CyberSkinCatalog_054 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_054";
        [SerializeField] private string courierName = "Courier Outfit #054";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (54 * 40);
        [SerializeField] private int requiredDistanceMeters = 54 * 900;
