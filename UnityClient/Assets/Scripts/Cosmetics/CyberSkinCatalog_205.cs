namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #205
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_205", menuName = "MetroRush/Cosmetics/Skin #205")]
    public class CyberSkinCatalog_205 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_205";
        [SerializeField] private string courierName = "Courier Outfit #205";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (205 * 40);
        [SerializeField] private int requiredDistanceMeters = 205 * 900;
