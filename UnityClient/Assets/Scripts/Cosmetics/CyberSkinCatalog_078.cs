namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #078
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_078", menuName = "MetroRush/Cosmetics/Skin #078")]
    public class CyberSkinCatalog_078 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_078";
        [SerializeField] private string courierName = "Courier Outfit #078";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (78 * 40);
        [SerializeField] private int requiredDistanceMeters = 78 * 900;
