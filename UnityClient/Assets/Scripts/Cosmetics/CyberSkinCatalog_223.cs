namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #223
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_223", menuName = "MetroRush/Cosmetics/Skin #223")]
    public class CyberSkinCatalog_223 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_223";
        [SerializeField] private string courierName = "Courier Outfit #223";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (223 * 40);
        [SerializeField] private int requiredDistanceMeters = 223 * 900;
