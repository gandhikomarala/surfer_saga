namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #233
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_233", menuName = "MetroRush/Cosmetics/Skin #233")]
    public class CyberSkinCatalog_233 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_233";
        [SerializeField] private string courierName = "Courier Outfit #233";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (233 * 40);
        [SerializeField] private int requiredDistanceMeters = 233 * 900;
