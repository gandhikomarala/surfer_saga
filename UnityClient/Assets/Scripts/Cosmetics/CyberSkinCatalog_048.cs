namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #048
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_048", menuName = "MetroRush/Cosmetics/Skin #048")]
    public class CyberSkinCatalog_048 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_048";
        [SerializeField] private string courierName = "Courier Outfit #048";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (48 * 40);
        [SerializeField] private int requiredDistanceMeters = 48 * 900;
