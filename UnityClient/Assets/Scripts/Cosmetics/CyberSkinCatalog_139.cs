namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #139
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_139", menuName = "MetroRush/Cosmetics/Skin #139")]
    public class CyberSkinCatalog_139 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_139";
        [SerializeField] private string courierName = "Courier Outfit #139";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (139 * 40);
        [SerializeField] private int requiredDistanceMeters = 139 * 900;
