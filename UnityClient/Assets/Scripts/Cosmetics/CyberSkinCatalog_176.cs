namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #176
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_176", menuName = "MetroRush/Cosmetics/Skin #176")]
    public class CyberSkinCatalog_176 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_176";
        [SerializeField] private string courierName = "Courier Outfit #176";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (176 * 40);
        [SerializeField] private int requiredDistanceMeters = 176 * 900;
