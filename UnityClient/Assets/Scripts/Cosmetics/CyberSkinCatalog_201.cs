namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #201
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_201", menuName = "MetroRush/Cosmetics/Skin #201")]
    public class CyberSkinCatalog_201 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_201";
        [SerializeField] private string courierName = "Courier Outfit #201";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (201 * 40);
        [SerializeField] private int requiredDistanceMeters = 201 * 900;
