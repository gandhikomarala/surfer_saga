namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #123
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_123", menuName = "MetroRush/Cosmetics/Skin #123")]
    public class CyberSkinCatalog_123 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_123";
        [SerializeField] private string courierName = "Courier Outfit #123";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (123 * 40);
        [SerializeField] private int requiredDistanceMeters = 123 * 900;
