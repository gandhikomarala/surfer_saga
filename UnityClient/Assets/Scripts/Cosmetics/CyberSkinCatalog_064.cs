namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #064
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_064", menuName = "MetroRush/Cosmetics/Skin #064")]
    public class CyberSkinCatalog_064 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_064";
        [SerializeField] private string courierName = "Courier Outfit #064";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (64 * 40);
        [SerializeField] private int requiredDistanceMeters = 64 * 900;
