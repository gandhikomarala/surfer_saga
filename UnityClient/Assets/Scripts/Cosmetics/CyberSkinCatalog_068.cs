namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #068
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_068", menuName = "MetroRush/Cosmetics/Skin #068")]
    public class CyberSkinCatalog_068 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_068";
        [SerializeField] private string courierName = "Courier Outfit #068";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (68 * 40);
        [SerializeField] private int requiredDistanceMeters = 68 * 900;
