namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #071
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_071", menuName = "MetroRush/Cosmetics/Skin #071")]
    public class CyberSkinCatalog_071 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_071";
        [SerializeField] private string courierName = "Courier Outfit #071";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (71 * 40);
        [SerializeField] private int requiredDistanceMeters = 71 * 900;
