namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #098
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_098", menuName = "MetroRush/Cosmetics/Skin #098")]
    public class CyberSkinCatalog_098 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_098";
        [SerializeField] private string courierName = "Courier Outfit #098";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (98 * 40);
        [SerializeField] private int requiredDistanceMeters = 98 * 900;
