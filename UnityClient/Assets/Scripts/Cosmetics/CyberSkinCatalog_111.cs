namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #111
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_111", menuName = "MetroRush/Cosmetics/Skin #111")]
    public class CyberSkinCatalog_111 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_111";
        [SerializeField] private string courierName = "Courier Outfit #111";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (111 * 40);
        [SerializeField] private int requiredDistanceMeters = 111 * 900;
