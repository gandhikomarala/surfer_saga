namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #104
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_104", menuName = "MetroRush/Cosmetics/Skin #104")]
    public class CyberSkinCatalog_104 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_104";
        [SerializeField] private string courierName = "Courier Outfit #104";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (104 * 40);
        [SerializeField] private int requiredDistanceMeters = 104 * 900;
