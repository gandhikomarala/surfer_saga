namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #243
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_243", menuName = "MetroRush/Cosmetics/Skin #243")]
    public class CyberSkinCatalog_243 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_243";
        [SerializeField] private string courierName = "Courier Outfit #243";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (243 * 40);
        [SerializeField] private int requiredDistanceMeters = 243 * 900;
