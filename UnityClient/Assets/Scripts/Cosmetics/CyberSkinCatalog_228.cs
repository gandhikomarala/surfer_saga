namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #228
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_228", menuName = "MetroRush/Cosmetics/Skin #228")]
    public class CyberSkinCatalog_228 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_228";
        [SerializeField] private string courierName = "Courier Outfit #228";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (228 * 40);
        [SerializeField] private int requiredDistanceMeters = 228 * 900;
