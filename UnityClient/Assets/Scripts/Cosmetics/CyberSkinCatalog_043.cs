namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #043
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_043", menuName = "MetroRush/Cosmetics/Skin #043")]
    public class CyberSkinCatalog_043 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_043";
        [SerializeField] private string courierName = "Courier Outfit #043";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (43 * 40);
        [SerializeField] private int requiredDistanceMeters = 43 * 900;
