namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #050
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_050", menuName = "MetroRush/Cosmetics/Skin #050")]
    public class CyberSkinCatalog_050 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_050";
        [SerializeField] private string courierName = "Courier Outfit #050";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (50 * 40);
        [SerializeField] private int requiredDistanceMeters = 50 * 900;
