namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #125
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_125", menuName = "MetroRush/Cosmetics/Skin #125")]
    public class CyberSkinCatalog_125 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_125";
        [SerializeField] private string courierName = "Courier Outfit #125";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (125 * 40);
        [SerializeField] private int requiredDistanceMeters = 125 * 900;
