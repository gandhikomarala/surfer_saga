namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #101
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_101", menuName = "MetroRush/Cosmetics/Skin #101")]
    public class CyberSkinCatalog_101 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_101";
        [SerializeField] private string courierName = "Courier Outfit #101";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (101 * 40);
        [SerializeField] private int requiredDistanceMeters = 101 * 900;
