namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #042
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_042", menuName = "MetroRush/Cosmetics/Skin #042")]
    public class CyberSkinCatalog_042 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_042";
        [SerializeField] private string courierName = "Courier Outfit #042";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (42 * 40);
        [SerializeField] private int requiredDistanceMeters = 42 * 900;
