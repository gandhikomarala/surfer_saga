namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #220
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_220", menuName = "MetroRush/Cosmetics/Skin #220")]
    public class CyberSkinCatalog_220 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_220";
        [SerializeField] private string courierName = "Courier Outfit #220";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (220 * 40);
        [SerializeField] private int requiredDistanceMeters = 220 * 900;
