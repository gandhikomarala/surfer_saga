namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #167
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_167", menuName = "MetroRush/Cosmetics/Skin #167")]
    public class CyberSkinCatalog_167 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_167";
        [SerializeField] private string courierName = "Courier Outfit #167";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (167 * 40);
        [SerializeField] private int requiredDistanceMeters = 167 * 900;
