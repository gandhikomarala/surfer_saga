namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #016
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_016", menuName = "MetroRush/Cosmetics/Skin #016")]
    public class CyberSkinCatalog_016 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_016";
        [SerializeField] private string courierName = "Courier Outfit #016";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (16 * 40);
        [SerializeField] private int requiredDistanceMeters = 16 * 900;
