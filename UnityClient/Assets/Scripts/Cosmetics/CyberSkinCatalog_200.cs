namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #200
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_200", menuName = "MetroRush/Cosmetics/Skin #200")]
    public class CyberSkinCatalog_200 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_200";
        [SerializeField] private string courierName = "Courier Outfit #200";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (200 * 40);
        [SerializeField] private int requiredDistanceMeters = 200 * 900;
