namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #207
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_207", menuName = "MetroRush/Cosmetics/Skin #207")]
    public class CyberSkinCatalog_207 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_207";
        [SerializeField] private string courierName = "Courier Outfit #207";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (207 * 40);
        [SerializeField] private int requiredDistanceMeters = 207 * 900;
