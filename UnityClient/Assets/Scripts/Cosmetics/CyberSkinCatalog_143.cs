namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #143
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_143", menuName = "MetroRush/Cosmetics/Skin #143")]
    public class CyberSkinCatalog_143 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_143";
        [SerializeField] private string courierName = "Courier Outfit #143";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (143 * 40);
        [SerializeField] private int requiredDistanceMeters = 143 * 900;
