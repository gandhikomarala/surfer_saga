namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #055
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_055", menuName = "MetroRush/Cosmetics/Skin #055")]
    public class CyberSkinCatalog_055 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_055";
        [SerializeField] private string courierName = "Courier Outfit #055";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (55 * 40);
        [SerializeField] private int requiredDistanceMeters = 55 * 900;
