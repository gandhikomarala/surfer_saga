namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #086
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_086", menuName = "MetroRush/Cosmetics/Skin #086")]
    public class CyberSkinCatalog_086 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_086";
        [SerializeField] private string courierName = "Courier Outfit #086";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (86 * 40);
        [SerializeField] private int requiredDistanceMeters = 86 * 900;
