namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #198
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_198", menuName = "MetroRush/Cosmetics/Skin #198")]
    public class CyberSkinCatalog_198 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_198";
        [SerializeField] private string courierName = "Courier Outfit #198";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (198 * 40);
        [SerializeField] private int requiredDistanceMeters = 198 * 900;
