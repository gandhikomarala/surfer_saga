namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #242
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_242", menuName = "MetroRush/Cosmetics/Skin #242")]
    public class CyberSkinCatalog_242 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_242";
        [SerializeField] private string courierName = "Courier Outfit #242";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (242 * 40);
        [SerializeField] private int requiredDistanceMeters = 242 * 900;
