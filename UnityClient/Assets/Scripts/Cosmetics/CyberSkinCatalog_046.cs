namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #046
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_046", menuName = "MetroRush/Cosmetics/Skin #046")]
    public class CyberSkinCatalog_046 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_046";
        [SerializeField] private string courierName = "Courier Outfit #046";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (46 * 40);
        [SerializeField] private int requiredDistanceMeters = 46 * 900;
