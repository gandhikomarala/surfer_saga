namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #151
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_151", menuName = "MetroRush/Cosmetics/Skin #151")]
    public class CyberSkinCatalog_151 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_151";
        [SerializeField] private string courierName = "Courier Outfit #151";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (151 * 40);
        [SerializeField] private int requiredDistanceMeters = 151 * 900;
