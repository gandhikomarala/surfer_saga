namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #047
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_047", menuName = "MetroRush/Cosmetics/Skin #047")]
    public class CyberSkinCatalog_047 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_047";
        [SerializeField] private string courierName = "Courier Outfit #047";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (47 * 40);
        [SerializeField] private int requiredDistanceMeters = 47 * 900;
