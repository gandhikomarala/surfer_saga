namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #187
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_187", menuName = "MetroRush/Cosmetics/Skin #187")]
    public class CyberSkinCatalog_187 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_187";
        [SerializeField] private string courierName = "Courier Outfit #187";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (187 * 40);
        [SerializeField] private int requiredDistanceMeters = 187 * 900;
