namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #174
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_174", menuName = "MetroRush/Cosmetics/Skin #174")]
    public class CyberSkinCatalog_174 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_174";
        [SerializeField] private string courierName = "Courier Outfit #174";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (174 * 40);
        [SerializeField] private int requiredDistanceMeters = 174 * 900;
