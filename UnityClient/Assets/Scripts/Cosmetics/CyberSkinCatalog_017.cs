namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #017
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_017", menuName = "MetroRush/Cosmetics/Skin #017")]
    public class CyberSkinCatalog_017 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_017";
        [SerializeField] private string courierName = "Courier Outfit #017";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (17 * 40);
        [SerializeField] private int requiredDistanceMeters = 17 * 900;
