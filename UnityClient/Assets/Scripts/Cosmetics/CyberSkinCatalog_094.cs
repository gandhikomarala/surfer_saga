namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #094
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_094", menuName = "MetroRush/Cosmetics/Skin #094")]
    public class CyberSkinCatalog_094 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_094";
        [SerializeField] private string courierName = "Courier Outfit #094";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (94 * 40);
        [SerializeField] private int requiredDistanceMeters = 94 * 900;
