namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #092
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_092", menuName = "MetroRush/Cosmetics/Skin #092")]
    public class CyberSkinCatalog_092 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_092";
        [SerializeField] private string courierName = "Courier Outfit #092";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (92 * 40);
        [SerializeField] private int requiredDistanceMeters = 92 * 900;
