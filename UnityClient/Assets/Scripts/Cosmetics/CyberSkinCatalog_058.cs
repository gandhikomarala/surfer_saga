namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #058
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_058", menuName = "MetroRush/Cosmetics/Skin #058")]
    public class CyberSkinCatalog_058 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_058";
        [SerializeField] private string courierName = "Courier Outfit #058";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (58 * 40);
        [SerializeField] private int requiredDistanceMeters = 58 * 900;
