namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #247
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_247", menuName = "MetroRush/Cosmetics/Skin #247")]
    public class CyberSkinCatalog_247 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_247";
        [SerializeField] private string courierName = "Courier Outfit #247";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (247 * 40);
        [SerializeField] private int requiredDistanceMeters = 247 * 900;
