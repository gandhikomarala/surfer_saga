namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #202
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_202", menuName = "MetroRush/Cosmetics/Skin #202")]
    public class CyberSkinCatalog_202 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_202";
        [SerializeField] private string courierName = "Courier Outfit #202";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (202 * 40);
        [SerializeField] private int requiredDistanceMeters = 202 * 900;
