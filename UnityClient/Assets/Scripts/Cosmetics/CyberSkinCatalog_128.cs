namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #128
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_128", menuName = "MetroRush/Cosmetics/Skin #128")]
    public class CyberSkinCatalog_128 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_128";
        [SerializeField] private string courierName = "Courier Outfit #128";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (128 * 40);
        [SerializeField] private int requiredDistanceMeters = 128 * 900;
