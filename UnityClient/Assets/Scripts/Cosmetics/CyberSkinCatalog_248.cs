namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #248
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_248", menuName = "MetroRush/Cosmetics/Skin #248")]
    public class CyberSkinCatalog_248 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_248";
        [SerializeField] private string courierName = "Courier Outfit #248";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (248 * 40);
        [SerializeField] private int requiredDistanceMeters = 248 * 900;
