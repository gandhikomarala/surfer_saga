namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #178
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_178", menuName = "MetroRush/Cosmetics/Skin #178")]
    public class CyberSkinCatalog_178 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_178";
        [SerializeField] private string courierName = "Courier Outfit #178";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (178 * 40);
        [SerializeField] private int requiredDistanceMeters = 178 * 900;
