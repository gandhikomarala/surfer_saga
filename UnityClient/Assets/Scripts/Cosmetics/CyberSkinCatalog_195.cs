namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #195
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_195", menuName = "MetroRush/Cosmetics/Skin #195")]
    public class CyberSkinCatalog_195 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_195";
        [SerializeField] private string courierName = "Courier Outfit #195";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (195 * 40);
        [SerializeField] private int requiredDistanceMeters = 195 * 900;
