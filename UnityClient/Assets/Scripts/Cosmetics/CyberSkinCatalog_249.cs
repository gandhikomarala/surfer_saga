namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #249
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_249", menuName = "MetroRush/Cosmetics/Skin #249")]
    public class CyberSkinCatalog_249 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_249";
        [SerializeField] private string courierName = "Courier Outfit #249";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (249 * 40);
        [SerializeField] private int requiredDistanceMeters = 249 * 900;
