namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #035
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_035", menuName = "MetroRush/Cosmetics/Skin #035")]
    public class CyberSkinCatalog_035 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_035";
        [SerializeField] private string courierName = "Courier Outfit #035";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (35 * 40);
        [SerializeField] private int requiredDistanceMeters = 35 * 900;
