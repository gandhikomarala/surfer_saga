namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #093
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_093", menuName = "MetroRush/Cosmetics/Skin #093")]
    public class CyberSkinCatalog_093 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_093";
        [SerializeField] private string courierName = "Courier Outfit #093";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (93 * 40);
        [SerializeField] private int requiredDistanceMeters = 93 * 900;
