namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #135
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_135", menuName = "MetroRush/Cosmetics/Skin #135")]
    public class CyberSkinCatalog_135 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_135";
        [SerializeField] private string courierName = "Courier Outfit #135";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (135 * 40);
        [SerializeField] private int requiredDistanceMeters = 135 * 900;
