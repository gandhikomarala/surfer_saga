namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #145
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_145", menuName = "MetroRush/Cosmetics/Skin #145")]
    public class CyberSkinCatalog_145 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_145";
        [SerializeField] private string courierName = "Courier Outfit #145";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (145 * 40);
        [SerializeField] private int requiredDistanceMeters = 145 * 900;
