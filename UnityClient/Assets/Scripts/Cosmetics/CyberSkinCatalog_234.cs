namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #234
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_234", menuName = "MetroRush/Cosmetics/Skin #234")]
    public class CyberSkinCatalog_234 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_234";
        [SerializeField] private string courierName = "Courier Outfit #234";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (234 * 40);
        [SerializeField] private int requiredDistanceMeters = 234 * 900;
