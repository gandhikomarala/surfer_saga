namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #030
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_030", menuName = "MetroRush/Cosmetics/Skin #030")]
    public class CyberSkinCatalog_030 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_030";
        [SerializeField] private string courierName = "Courier Outfit #030";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (30 * 40);
        [SerializeField] private int requiredDistanceMeters = 30 * 900;
