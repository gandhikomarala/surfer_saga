namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #105
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_105", menuName = "MetroRush/Cosmetics/Skin #105")]
    public class CyberSkinCatalog_105 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_105";
        [SerializeField] private string courierName = "Courier Outfit #105";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (105 * 40);
        [SerializeField] private int requiredDistanceMeters = 105 * 900;
