namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #026
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_026", menuName = "MetroRush/Cosmetics/Skin #026")]
    public class CyberSkinCatalog_026 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_026";
        [SerializeField] private string courierName = "Courier Outfit #026";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (26 * 40);
        [SerializeField] private int requiredDistanceMeters = 26 * 900;
