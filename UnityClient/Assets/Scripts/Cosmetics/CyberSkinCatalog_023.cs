namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #023
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_023", menuName = "MetroRush/Cosmetics/Skin #023")]
    public class CyberSkinCatalog_023 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_023";
        [SerializeField] private string courierName = "Courier Outfit #023";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (23 * 40);
        [SerializeField] private int requiredDistanceMeters = 23 * 900;
