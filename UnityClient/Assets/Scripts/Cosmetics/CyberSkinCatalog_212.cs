namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #212
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_212", menuName = "MetroRush/Cosmetics/Skin #212")]
    public class CyberSkinCatalog_212 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_212";
        [SerializeField] private string courierName = "Courier Outfit #212";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (212 * 40);
        [SerializeField] private int requiredDistanceMeters = 212 * 900;
