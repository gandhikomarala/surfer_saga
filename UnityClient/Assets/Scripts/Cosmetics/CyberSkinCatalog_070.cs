namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #070
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_070", menuName = "MetroRush/Cosmetics/Skin #070")]
    public class CyberSkinCatalog_070 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_070";
        [SerializeField] private string courierName = "Courier Outfit #070";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (70 * 40);
        [SerializeField] private int requiredDistanceMeters = 70 * 900;
