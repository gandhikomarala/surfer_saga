namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #197
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_197", menuName = "MetroRush/Cosmetics/Skin #197")]
    public class CyberSkinCatalog_197 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_197";
        [SerializeField] private string courierName = "Courier Outfit #197";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (197 * 40);
        [SerializeField] private int requiredDistanceMeters = 197 * 900;
