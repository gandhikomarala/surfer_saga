namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #245
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_245", menuName = "MetroRush/Cosmetics/Skin #245")]
    public class CyberSkinCatalog_245 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_245";
        [SerializeField] private string courierName = "Courier Outfit #245";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (245 * 40);
        [SerializeField] private int requiredDistanceMeters = 245 * 900;
