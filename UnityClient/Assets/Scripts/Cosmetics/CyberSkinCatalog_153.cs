namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #153
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_153", menuName = "MetroRush/Cosmetics/Skin #153")]
    public class CyberSkinCatalog_153 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_153";
        [SerializeField] private string courierName = "Courier Outfit #153";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (153 * 40);
        [SerializeField] private int requiredDistanceMeters = 153 * 900;
