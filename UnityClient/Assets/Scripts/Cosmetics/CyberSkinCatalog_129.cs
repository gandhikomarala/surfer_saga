namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #129
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_129", menuName = "MetroRush/Cosmetics/Skin #129")]
    public class CyberSkinCatalog_129 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_129";
        [SerializeField] private string courierName = "Courier Outfit #129";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (129 * 40);
        [SerializeField] private int requiredDistanceMeters = 129 * 900;
