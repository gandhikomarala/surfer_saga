namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #164
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_164", menuName = "MetroRush/Cosmetics/Skin #164")]
    public class CyberSkinCatalog_164 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_164";
        [SerializeField] private string courierName = "Courier Outfit #164";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (164 * 40);
        [SerializeField] private int requiredDistanceMeters = 164 * 900;
