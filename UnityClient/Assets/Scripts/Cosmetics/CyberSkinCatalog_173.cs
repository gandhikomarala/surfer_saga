namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #173
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_173", menuName = "MetroRush/Cosmetics/Skin #173")]
    public class CyberSkinCatalog_173 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_173";
        [SerializeField] private string courierName = "Courier Outfit #173";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (173 * 40);
        [SerializeField] private int requiredDistanceMeters = 173 * 900;
