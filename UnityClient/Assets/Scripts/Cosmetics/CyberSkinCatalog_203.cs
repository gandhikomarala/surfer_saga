namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #203
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_203", menuName = "MetroRush/Cosmetics/Skin #203")]
    public class CyberSkinCatalog_203 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_203";
        [SerializeField] private string courierName = "Courier Outfit #203";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (203 * 40);
        [SerializeField] private int requiredDistanceMeters = 203 * 900;
