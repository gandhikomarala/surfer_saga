namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #036
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_036", menuName = "MetroRush/Cosmetics/Skin #036")]
    public class CyberSkinCatalog_036 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_036";
        [SerializeField] private string courierName = "Courier Outfit #036";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (36 * 40);
        [SerializeField] private int requiredDistanceMeters = 36 * 900;
