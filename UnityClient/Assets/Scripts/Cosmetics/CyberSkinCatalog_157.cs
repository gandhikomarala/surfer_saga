namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #157
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_157", menuName = "MetroRush/Cosmetics/Skin #157")]
    public class CyberSkinCatalog_157 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_157";
        [SerializeField] private string courierName = "Courier Outfit #157";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (157 * 40);
        [SerializeField] private int requiredDistanceMeters = 157 * 900;
