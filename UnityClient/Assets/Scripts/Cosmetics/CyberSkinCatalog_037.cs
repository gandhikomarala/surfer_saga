namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #037
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_037", menuName = "MetroRush/Cosmetics/Skin #037")]
    public class CyberSkinCatalog_037 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_037";
        [SerializeField] private string courierName = "Courier Outfit #037";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (37 * 40);
        [SerializeField] private int requiredDistanceMeters = 37 * 900;
