namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #112
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_112", menuName = "MetroRush/Cosmetics/Skin #112")]
    public class CyberSkinCatalog_112 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_112";
        [SerializeField] private string courierName = "Courier Outfit #112";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (112 * 40);
        [SerializeField] private int requiredDistanceMeters = 112 * 900;
