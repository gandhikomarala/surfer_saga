namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #077
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_077", menuName = "MetroRush/Cosmetics/Skin #077")]
    public class CyberSkinCatalog_077 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_077";
        [SerializeField] private string courierName = "Courier Outfit #077";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (77 * 40);
        [SerializeField] private int requiredDistanceMeters = 77 * 900;
