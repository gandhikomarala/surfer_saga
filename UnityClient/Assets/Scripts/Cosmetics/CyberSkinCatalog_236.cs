namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #236
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_236", menuName = "MetroRush/Cosmetics/Skin #236")]
    public class CyberSkinCatalog_236 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_236";
        [SerializeField] private string courierName = "Courier Outfit #236";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (236 * 40);
        [SerializeField] private int requiredDistanceMeters = 236 * 900;
