namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #010
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_010", menuName = "MetroRush/Cosmetics/Skin #010")]
    public class CyberSkinCatalog_010 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_010";
        [SerializeField] private string courierName = "Courier Outfit #010";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (10 * 40);
        [SerializeField] private int requiredDistanceMeters = 10 * 900;
