namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #044
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_044", menuName = "MetroRush/Cosmetics/Skin #044")]
    public class CyberSkinCatalog_044 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_044";
        [SerializeField] private string courierName = "Courier Outfit #044";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (44 * 40);
        [SerializeField] private int requiredDistanceMeters = 44 * 900;
