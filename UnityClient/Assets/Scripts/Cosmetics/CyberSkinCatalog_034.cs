namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #034
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_034", menuName = "MetroRush/Cosmetics/Skin #034")]
    public class CyberSkinCatalog_034 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_034";
        [SerializeField] private string courierName = "Courier Outfit #034";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (34 * 40);
        [SerializeField] private int requiredDistanceMeters = 34 * 900;
