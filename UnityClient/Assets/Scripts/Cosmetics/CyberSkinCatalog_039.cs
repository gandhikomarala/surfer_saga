namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #039
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_039", menuName = "MetroRush/Cosmetics/Skin #039")]
    public class CyberSkinCatalog_039 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_039";
        [SerializeField] private string courierName = "Courier Outfit #039";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (39 * 40);
        [SerializeField] private int requiredDistanceMeters = 39 * 900;
