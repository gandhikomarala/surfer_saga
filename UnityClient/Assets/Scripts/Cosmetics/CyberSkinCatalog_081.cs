namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #081
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_081", menuName = "MetroRush/Cosmetics/Skin #081")]
    public class CyberSkinCatalog_081 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_081";
        [SerializeField] private string courierName = "Courier Outfit #081";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (81 * 40);
        [SerializeField] private int requiredDistanceMeters = 81 * 900;
