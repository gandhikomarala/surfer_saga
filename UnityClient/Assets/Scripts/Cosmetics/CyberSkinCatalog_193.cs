namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #193
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_193", menuName = "MetroRush/Cosmetics/Skin #193")]
    public class CyberSkinCatalog_193 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_193";
        [SerializeField] private string courierName = "Courier Outfit #193";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (193 * 40);
        [SerializeField] private int requiredDistanceMeters = 193 * 900;
