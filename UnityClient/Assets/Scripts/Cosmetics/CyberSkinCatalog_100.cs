namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #100
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_100", menuName = "MetroRush/Cosmetics/Skin #100")]
    public class CyberSkinCatalog_100 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_100";
        [SerializeField] private string courierName = "Courier Outfit #100";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (100 * 40);
        [SerializeField] private int requiredDistanceMeters = 100 * 900;
