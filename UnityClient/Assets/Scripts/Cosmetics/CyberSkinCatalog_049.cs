namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #049
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_049", menuName = "MetroRush/Cosmetics/Skin #049")]
    public class CyberSkinCatalog_049 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_049";
        [SerializeField] private string courierName = "Courier Outfit #049";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (49 * 40);
        [SerializeField] private int requiredDistanceMeters = 49 * 900;
