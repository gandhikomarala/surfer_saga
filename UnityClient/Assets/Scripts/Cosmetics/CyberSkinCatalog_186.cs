namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #186
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_186", menuName = "MetroRush/Cosmetics/Skin #186")]
    public class CyberSkinCatalog_186 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_186";
        [SerializeField] private string courierName = "Courier Outfit #186";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (186 * 40);
        [SerializeField] private int requiredDistanceMeters = 186 * 900;
