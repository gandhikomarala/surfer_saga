namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #095
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_095", menuName = "MetroRush/Cosmetics/Skin #095")]
    public class CyberSkinCatalog_095 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_095";
        [SerializeField] private string courierName = "Courier Outfit #095";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (95 * 40);
        [SerializeField] private int requiredDistanceMeters = 95 * 900;
