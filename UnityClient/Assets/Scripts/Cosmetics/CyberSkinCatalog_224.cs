namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #224
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_224", menuName = "MetroRush/Cosmetics/Skin #224")]
    public class CyberSkinCatalog_224 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_224";
        [SerializeField] private string courierName = "Courier Outfit #224";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (224 * 40);
        [SerializeField] private int requiredDistanceMeters = 224 * 900;
