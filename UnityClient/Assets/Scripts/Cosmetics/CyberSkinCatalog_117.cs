namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #117
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_117", menuName = "MetroRush/Cosmetics/Skin #117")]
    public class CyberSkinCatalog_117 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_117";
        [SerializeField] private string courierName = "Courier Outfit #117";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (117 * 40);
        [SerializeField] private int requiredDistanceMeters = 117 * 900;
