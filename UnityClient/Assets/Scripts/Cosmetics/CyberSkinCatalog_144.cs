namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #144
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_144", menuName = "MetroRush/Cosmetics/Skin #144")]
    public class CyberSkinCatalog_144 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_144";
        [SerializeField] private string courierName = "Courier Outfit #144";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (144 * 40);
        [SerializeField] private int requiredDistanceMeters = 144 * 900;
