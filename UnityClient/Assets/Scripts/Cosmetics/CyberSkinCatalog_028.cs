namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #028
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_028", menuName = "MetroRush/Cosmetics/Skin #028")]
    public class CyberSkinCatalog_028 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_028";
        [SerializeField] private string courierName = "Courier Outfit #028";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (28 * 40);
        [SerializeField] private int requiredDistanceMeters = 28 * 900;
