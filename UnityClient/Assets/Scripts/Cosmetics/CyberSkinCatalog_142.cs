namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #142
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_142", menuName = "MetroRush/Cosmetics/Skin #142")]
    public class CyberSkinCatalog_142 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_142";
        [SerializeField] private string courierName = "Courier Outfit #142";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (142 * 40);
        [SerializeField] private int requiredDistanceMeters = 142 * 900;
