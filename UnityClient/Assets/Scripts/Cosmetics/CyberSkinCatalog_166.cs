namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #166
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_166", menuName = "MetroRush/Cosmetics/Skin #166")]
    public class CyberSkinCatalog_166 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_166";
        [SerializeField] private string courierName = "Courier Outfit #166";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (166 * 40);
        [SerializeField] private int requiredDistanceMeters = 166 * 900;
