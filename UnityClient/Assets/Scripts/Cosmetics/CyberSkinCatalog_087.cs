namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #087
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_087", menuName = "MetroRush/Cosmetics/Skin #087")]
    public class CyberSkinCatalog_087 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_087";
        [SerializeField] private string courierName = "Courier Outfit #087";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (87 * 40);
        [SerializeField] private int requiredDistanceMeters = 87 * 900;
