namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #122
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_122", menuName = "MetroRush/Cosmetics/Skin #122")]
    public class CyberSkinCatalog_122 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_122";
        [SerializeField] private string courierName = "Courier Outfit #122";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (122 * 40);
        [SerializeField] private int requiredDistanceMeters = 122 * 900;
