namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #029
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_029", menuName = "MetroRush/Cosmetics/Skin #029")]
    public class CyberSkinCatalog_029 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_029";
        [SerializeField] private string courierName = "Courier Outfit #029";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (29 * 40);
        [SerializeField] private int requiredDistanceMeters = 29 * 900;
