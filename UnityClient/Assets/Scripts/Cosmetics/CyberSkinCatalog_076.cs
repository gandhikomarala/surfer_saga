namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #076
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_076", menuName = "MetroRush/Cosmetics/Skin #076")]
    public class CyberSkinCatalog_076 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_076";
        [SerializeField] private string courierName = "Courier Outfit #076";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (76 * 40);
        [SerializeField] private int requiredDistanceMeters = 76 * 900;
