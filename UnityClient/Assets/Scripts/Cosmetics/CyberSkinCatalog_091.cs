namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #091
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_091", menuName = "MetroRush/Cosmetics/Skin #091")]
    public class CyberSkinCatalog_091 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_091";
        [SerializeField] private string courierName = "Courier Outfit #091";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (91 * 40);
        [SerializeField] private int requiredDistanceMeters = 91 * 900;
