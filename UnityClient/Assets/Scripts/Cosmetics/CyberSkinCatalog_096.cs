namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #096
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_096", menuName = "MetroRush/Cosmetics/Skin #096")]
    public class CyberSkinCatalog_096 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_096";
        [SerializeField] private string courierName = "Courier Outfit #096";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (96 * 40);
        [SerializeField] private int requiredDistanceMeters = 96 * 900;
