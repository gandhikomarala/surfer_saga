namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #218
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_218", menuName = "MetroRush/Cosmetics/Skin #218")]
    public class CyberSkinCatalog_218 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_218";
        [SerializeField] private string courierName = "Courier Outfit #218";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (218 * 40);
        [SerializeField] private int requiredDistanceMeters = 218 * 900;
