namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #185
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_185", menuName = "MetroRush/Cosmetics/Skin #185")]
    public class CyberSkinCatalog_185 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_185";
        [SerializeField] private string courierName = "Courier Outfit #185";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (185 * 40);
        [SerializeField] private int requiredDistanceMeters = 185 * 900;
