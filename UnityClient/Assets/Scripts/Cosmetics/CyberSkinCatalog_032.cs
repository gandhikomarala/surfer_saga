namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #032
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_032", menuName = "MetroRush/Cosmetics/Skin #032")]
    public class CyberSkinCatalog_032 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_032";
        [SerializeField] private string courierName = "Courier Outfit #032";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (32 * 40);
        [SerializeField] private int requiredDistanceMeters = 32 * 900;
