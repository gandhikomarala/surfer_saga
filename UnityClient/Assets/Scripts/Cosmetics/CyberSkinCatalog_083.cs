namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #083
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_083", menuName = "MetroRush/Cosmetics/Skin #083")]
    public class CyberSkinCatalog_083 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_083";
        [SerializeField] private string courierName = "Courier Outfit #083";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (83 * 40);
        [SerializeField] private int requiredDistanceMeters = 83 * 900;
