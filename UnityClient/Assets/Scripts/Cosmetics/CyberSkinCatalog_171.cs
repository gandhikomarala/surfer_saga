namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #171
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_171", menuName = "MetroRush/Cosmetics/Skin #171")]
    public class CyberSkinCatalog_171 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_171";
        [SerializeField] private string courierName = "Courier Outfit #171";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (171 * 40);
        [SerializeField] private int requiredDistanceMeters = 171 * 900;
