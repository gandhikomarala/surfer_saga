namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #231
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_231", menuName = "MetroRush/Cosmetics/Skin #231")]
    public class CyberSkinCatalog_231 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_231";
        [SerializeField] private string courierName = "Courier Outfit #231";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (231 * 40);
        [SerializeField] private int requiredDistanceMeters = 231 * 900;
