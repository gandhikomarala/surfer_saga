namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #168
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_168", menuName = "MetroRush/Cosmetics/Skin #168")]
    public class CyberSkinCatalog_168 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_168";
        [SerializeField] private string courierName = "Courier Outfit #168";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (168 * 40);
        [SerializeField] private int requiredDistanceMeters = 168 * 900;
