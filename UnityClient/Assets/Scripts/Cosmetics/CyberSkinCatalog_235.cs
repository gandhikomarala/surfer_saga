namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #235
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_235", menuName = "MetroRush/Cosmetics/Skin #235")]
    public class CyberSkinCatalog_235 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_235";
        [SerializeField] private string courierName = "Courier Outfit #235";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (235 * 40);
        [SerializeField] private int requiredDistanceMeters = 235 * 900;
