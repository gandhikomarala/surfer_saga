namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #115
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_115", menuName = "MetroRush/Cosmetics/Skin #115")]
    public class CyberSkinCatalog_115 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_115";
        [SerializeField] private string courierName = "Courier Outfit #115";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (115 * 40);
        [SerializeField] private int requiredDistanceMeters = 115 * 900;
