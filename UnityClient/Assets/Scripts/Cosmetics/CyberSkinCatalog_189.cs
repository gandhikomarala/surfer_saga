namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #189
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_189", menuName = "MetroRush/Cosmetics/Skin #189")]
    public class CyberSkinCatalog_189 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_189";
        [SerializeField] private string courierName = "Courier Outfit #189";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (189 * 40);
        [SerializeField] private int requiredDistanceMeters = 189 * 900;
