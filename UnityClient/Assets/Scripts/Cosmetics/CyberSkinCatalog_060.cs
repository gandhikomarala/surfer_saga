namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #060
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_060", menuName = "MetroRush/Cosmetics/Skin #060")]
    public class CyberSkinCatalog_060 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_060";
        [SerializeField] private string courierName = "Courier Outfit #060";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (60 * 40);
        [SerializeField] private int requiredDistanceMeters = 60 * 900;
