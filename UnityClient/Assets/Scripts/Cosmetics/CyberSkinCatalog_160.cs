namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #160
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_160", menuName = "MetroRush/Cosmetics/Skin #160")]
    public class CyberSkinCatalog_160 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_160";
        [SerializeField] private string courierName = "Courier Outfit #160";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (160 * 40);
        [SerializeField] private int requiredDistanceMeters = 160 * 900;
