namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #084
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_084", menuName = "MetroRush/Cosmetics/Skin #084")]
    public class CyberSkinCatalog_084 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_084";
        [SerializeField] private string courierName = "Courier Outfit #084";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (84 * 40);
        [SerializeField] private int requiredDistanceMeters = 84 * 900;
