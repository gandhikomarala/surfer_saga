namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #022
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_022", menuName = "MetroRush/Cosmetics/Skin #022")]
    public class CyberSkinCatalog_022 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_022";
        [SerializeField] private string courierName = "Courier Outfit #022";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (22 * 40);
        [SerializeField] private int requiredDistanceMeters = 22 * 900;
