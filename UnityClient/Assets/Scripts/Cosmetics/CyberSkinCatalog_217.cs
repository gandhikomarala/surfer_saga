namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #217
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_217", menuName = "MetroRush/Cosmetics/Skin #217")]
    public class CyberSkinCatalog_217 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_217";
        [SerializeField] private string courierName = "Courier Outfit #217";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (217 * 40);
        [SerializeField] private int requiredDistanceMeters = 217 * 900;
