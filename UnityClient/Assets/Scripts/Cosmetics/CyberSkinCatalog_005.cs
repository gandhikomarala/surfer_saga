namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #005
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_005", menuName = "MetroRush/Cosmetics/Skin #005")]
    public class CyberSkinCatalog_005 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_005";
        [SerializeField] private string courierName = "Courier Outfit #005";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (5 * 40);
        [SerializeField] private int requiredDistanceMeters = 5 * 900;
