namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #184
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_184", menuName = "MetroRush/Cosmetics/Skin #184")]
    public class CyberSkinCatalog_184 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_184";
        [SerializeField] private string courierName = "Courier Outfit #184";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (184 * 40);
        [SerializeField] private int requiredDistanceMeters = 184 * 900;
