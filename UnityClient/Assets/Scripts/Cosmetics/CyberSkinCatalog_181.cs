namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #181
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_181", menuName = "MetroRush/Cosmetics/Skin #181")]
    public class CyberSkinCatalog_181 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_181";
        [SerializeField] private string courierName = "Courier Outfit #181";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (181 * 40);
        [SerializeField] private int requiredDistanceMeters = 181 * 900;
