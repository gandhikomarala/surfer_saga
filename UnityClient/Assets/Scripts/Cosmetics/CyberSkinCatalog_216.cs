namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #216
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_216", menuName = "MetroRush/Cosmetics/Skin #216")]
    public class CyberSkinCatalog_216 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_216";
        [SerializeField] private string courierName = "Courier Outfit #216";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (216 * 40);
        [SerializeField] private int requiredDistanceMeters = 216 * 900;
