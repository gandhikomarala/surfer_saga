namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #149
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_149", menuName = "MetroRush/Cosmetics/Skin #149")]
    public class CyberSkinCatalog_149 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_149";
        [SerializeField] private string courierName = "Courier Outfit #149";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (149 * 40);
        [SerializeField] private int requiredDistanceMeters = 149 * 900;
