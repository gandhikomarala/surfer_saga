namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #004
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_004", menuName = "MetroRush/Cosmetics/Skin #004")]
    public class CyberSkinCatalog_004 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_004";
        [SerializeField] private string courierName = "Courier Outfit #004";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (4 * 40);
        [SerializeField] private int requiredDistanceMeters = 4 * 900;
