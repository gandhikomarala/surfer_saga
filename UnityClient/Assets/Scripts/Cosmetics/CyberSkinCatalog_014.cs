namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #014
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_014", menuName = "MetroRush/Cosmetics/Skin #014")]
    public class CyberSkinCatalog_014 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_014";
        [SerializeField] private string courierName = "Courier Outfit #014";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (14 * 40);
        [SerializeField] private int requiredDistanceMeters = 14 * 900;
