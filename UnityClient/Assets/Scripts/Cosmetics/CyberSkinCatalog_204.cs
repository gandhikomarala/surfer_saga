namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #204
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_204", menuName = "MetroRush/Cosmetics/Skin #204")]
    public class CyberSkinCatalog_204 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_204";
        [SerializeField] private string courierName = "Courier Outfit #204";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (204 * 40);
        [SerializeField] private int requiredDistanceMeters = 204 * 900;
