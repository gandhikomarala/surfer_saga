namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #172
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_172", menuName = "MetroRush/Cosmetics/Skin #172")]
    public class CyberSkinCatalog_172 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_172";
        [SerializeField] private string courierName = "Courier Outfit #172";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (172 * 40);
        [SerializeField] private int requiredDistanceMeters = 172 * 900;
