namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #116
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_116", menuName = "MetroRush/Cosmetics/Skin #116")]
    public class CyberSkinCatalog_116 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_116";
        [SerializeField] private string courierName = "Courier Outfit #116";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (116 * 40);
        [SerializeField] private int requiredDistanceMeters = 116 * 900;
