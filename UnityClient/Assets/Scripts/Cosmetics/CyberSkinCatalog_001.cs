namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #001
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_001", menuName = "MetroRush/Cosmetics/Skin #001")]
    public class CyberSkinCatalog_001 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_001";
        [SerializeField] private string courierName = "Courier Outfit #001";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (1 * 40);
        [SerializeField] private int requiredDistanceMeters = 1 * 900;
