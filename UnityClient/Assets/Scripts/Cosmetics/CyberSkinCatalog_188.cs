namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #188
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_188", menuName = "MetroRush/Cosmetics/Skin #188")]
    public class CyberSkinCatalog_188 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_188";
        [SerializeField] private string courierName = "Courier Outfit #188";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (188 * 40);
        [SerializeField] private int requiredDistanceMeters = 188 * 900;
