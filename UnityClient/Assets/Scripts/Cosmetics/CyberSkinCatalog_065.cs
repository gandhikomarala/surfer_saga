namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #065
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_065", menuName = "MetroRush/Cosmetics/Skin #065")]
    public class CyberSkinCatalog_065 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_065";
        [SerializeField] private string courierName = "Courier Outfit #065";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (65 * 40);
        [SerializeField] private int requiredDistanceMeters = 65 * 900;
