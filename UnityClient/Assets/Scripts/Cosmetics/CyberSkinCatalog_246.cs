namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #246
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_246", menuName = "MetroRush/Cosmetics/Skin #246")]
    public class CyberSkinCatalog_246 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_246";
        [SerializeField] private string courierName = "Courier Outfit #246";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (246 * 40);
        [SerializeField] private int requiredDistanceMeters = 246 * 900;
