namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #079
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_079", menuName = "MetroRush/Cosmetics/Skin #079")]
    public class CyberSkinCatalog_079 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_079";
        [SerializeField] private string courierName = "Courier Outfit #079";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (79 * 40);
        [SerializeField] private int requiredDistanceMeters = 79 * 900;
