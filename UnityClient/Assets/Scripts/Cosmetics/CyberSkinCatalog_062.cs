namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #062
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_062", menuName = "MetroRush/Cosmetics/Skin #062")]
    public class CyberSkinCatalog_062 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_062";
        [SerializeField] private string courierName = "Courier Outfit #062";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (62 * 40);
        [SerializeField] private int requiredDistanceMeters = 62 * 900;
