namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #033
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_033", menuName = "MetroRush/Cosmetics/Skin #033")]
    public class CyberSkinCatalog_033 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_033";
        [SerializeField] private string courierName = "Courier Outfit #033";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (33 * 40);
        [SerializeField] private int requiredDistanceMeters = 33 * 900;
