namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #012
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_012", menuName = "MetroRush/Cosmetics/Skin #012")]
    public class CyberSkinCatalog_012 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_012";
        [SerializeField] private string courierName = "Courier Outfit #012";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (12 * 40);
        [SerializeField] private int requiredDistanceMeters = 12 * 900;
