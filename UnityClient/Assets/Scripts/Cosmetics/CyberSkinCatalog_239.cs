namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #239
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_239", menuName = "MetroRush/Cosmetics/Skin #239")]
    public class CyberSkinCatalog_239 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_239";
        [SerializeField] private string courierName = "Courier Outfit #239";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (239 * 40);
        [SerializeField] private int requiredDistanceMeters = 239 * 900;
