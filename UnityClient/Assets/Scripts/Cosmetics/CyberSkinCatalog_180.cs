namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #180
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_180", menuName = "MetroRush/Cosmetics/Skin #180")]
    public class CyberSkinCatalog_180 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_180";
        [SerializeField] private string courierName = "Courier Outfit #180";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (180 * 40);
        [SerializeField] private int requiredDistanceMeters = 180 * 900;
