namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #219
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_219", menuName = "MetroRush/Cosmetics/Skin #219")]
    public class CyberSkinCatalog_219 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_219";
        [SerializeField] private string courierName = "Courier Outfit #219";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (219 * 40);
        [SerializeField] private int requiredDistanceMeters = 219 * 900;
