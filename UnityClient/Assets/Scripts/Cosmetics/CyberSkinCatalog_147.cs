namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #147
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_147", menuName = "MetroRush/Cosmetics/Skin #147")]
    public class CyberSkinCatalog_147 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_147";
        [SerializeField] private string courierName = "Courier Outfit #147";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (147 * 40);
        [SerializeField] private int requiredDistanceMeters = 147 * 900;
