namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #194
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_194", menuName = "MetroRush/Cosmetics/Skin #194")]
    public class CyberSkinCatalog_194 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_194";
        [SerializeField] private string courierName = "Courier Outfit #194";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (194 * 40);
        [SerializeField] private int requiredDistanceMeters = 194 * 900;
