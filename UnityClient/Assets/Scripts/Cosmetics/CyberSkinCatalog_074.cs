namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #074
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_074", menuName = "MetroRush/Cosmetics/Skin #074")]
    public class CyberSkinCatalog_074 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_074";
        [SerializeField] private string courierName = "Courier Outfit #074";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (74 * 40);
        [SerializeField] private int requiredDistanceMeters = 74 * 900;
