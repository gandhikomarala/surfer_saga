namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #007
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_007", menuName = "MetroRush/Cosmetics/Skin #007")]
    public class CyberSkinCatalog_007 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_007";
        [SerializeField] private string courierName = "Courier Outfit #007";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (7 * 40);
        [SerializeField] private int requiredDistanceMeters = 7 * 900;
