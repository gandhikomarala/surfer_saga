namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #056
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_056", menuName = "MetroRush/Cosmetics/Skin #056")]
    public class CyberSkinCatalog_056 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_056";
        [SerializeField] private string courierName = "Courier Outfit #056";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (56 * 40);
        [SerializeField] private int requiredDistanceMeters = 56 * 900;
