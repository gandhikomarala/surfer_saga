namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #209
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_209", menuName = "MetroRush/Cosmetics/Skin #209")]
    public class CyberSkinCatalog_209 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_209";
        [SerializeField] private string courierName = "Courier Outfit #209";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (209 * 40);
        [SerializeField] private int requiredDistanceMeters = 209 * 900;
