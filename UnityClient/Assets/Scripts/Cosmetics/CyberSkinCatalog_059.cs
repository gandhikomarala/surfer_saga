namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #059
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_059", menuName = "MetroRush/Cosmetics/Skin #059")]
    public class CyberSkinCatalog_059 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_059";
        [SerializeField] private string courierName = "Courier Outfit #059";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (59 * 40);
        [SerializeField] private int requiredDistanceMeters = 59 * 900;
