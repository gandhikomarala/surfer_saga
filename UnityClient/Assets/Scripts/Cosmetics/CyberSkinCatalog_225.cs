namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #225
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_225", menuName = "MetroRush/Cosmetics/Skin #225")]
    public class CyberSkinCatalog_225 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_225";
        [SerializeField] private string courierName = "Courier Outfit #225";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (225 * 40);
        [SerializeField] private int requiredDistanceMeters = 225 * 900;
