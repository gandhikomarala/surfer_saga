namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #002
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_002", menuName = "MetroRush/Cosmetics/Skin #002")]
    public class CyberSkinCatalog_002 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_002";
        [SerializeField] private string courierName = "Courier Outfit #002";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (2 * 40);
        [SerializeField] private int requiredDistanceMeters = 2 * 900;
