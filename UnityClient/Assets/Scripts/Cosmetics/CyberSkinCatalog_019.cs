namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #019
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_019", menuName = "MetroRush/Cosmetics/Skin #019")]
    public class CyberSkinCatalog_019 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_019";
        [SerializeField] private string courierName = "Courier Outfit #019";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (19 * 40);
        [SerializeField] private int requiredDistanceMeters = 19 * 900;
