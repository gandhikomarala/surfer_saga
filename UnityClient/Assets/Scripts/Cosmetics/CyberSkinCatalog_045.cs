namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #045
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_045", menuName = "MetroRush/Cosmetics/Skin #045")]
    public class CyberSkinCatalog_045 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_045";
        [SerializeField] private string courierName = "Courier Outfit #045";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (45 * 40);
        [SerializeField] private int requiredDistanceMeters = 45 * 900;
