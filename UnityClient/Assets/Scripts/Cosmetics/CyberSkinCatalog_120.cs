namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #120
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_120", menuName = "MetroRush/Cosmetics/Skin #120")]
    public class CyberSkinCatalog_120 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_120";
        [SerializeField] private string courierName = "Courier Outfit #120";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (120 * 40);
        [SerializeField] private int requiredDistanceMeters = 120 * 900;
