namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #011
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_011", menuName = "MetroRush/Cosmetics/Skin #011")]
    public class CyberSkinCatalog_011 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_011";
        [SerializeField] private string courierName = "Courier Outfit #011";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (11 * 40);
        [SerializeField] private int requiredDistanceMeters = 11 * 900;
