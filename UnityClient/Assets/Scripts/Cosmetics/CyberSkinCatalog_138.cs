namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #138
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_138", menuName = "MetroRush/Cosmetics/Skin #138")]
    public class CyberSkinCatalog_138 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_138";
        [SerializeField] private string courierName = "Courier Outfit #138";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (138 * 40);
        [SerializeField] private int requiredDistanceMeters = 138 * 900;
