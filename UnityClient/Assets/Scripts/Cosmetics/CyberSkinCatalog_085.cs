namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #085
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_085", menuName = "MetroRush/Cosmetics/Skin #085")]
    public class CyberSkinCatalog_085 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_085";
        [SerializeField] private string courierName = "Courier Outfit #085";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (85 * 40);
        [SerializeField] private int requiredDistanceMeters = 85 * 900;
