namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #003
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_003", menuName = "MetroRush/Cosmetics/Skin #003")]
    public class CyberSkinCatalog_003 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_003";
        [SerializeField] private string courierName = "Courier Outfit #003";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (3 * 40);
        [SerializeField] private int requiredDistanceMeters = 3 * 900;
