namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #006
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_006", menuName = "MetroRush/Cosmetics/Skin #006")]
    public class CyberSkinCatalog_006 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_006";
        [SerializeField] private string courierName = "Courier Outfit #006";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (6 * 40);
        [SerializeField] private int requiredDistanceMeters = 6 * 900;
