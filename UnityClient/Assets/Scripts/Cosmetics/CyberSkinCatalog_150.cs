namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #150
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_150", menuName = "MetroRush/Cosmetics/Skin #150")]
    public class CyberSkinCatalog_150 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_150";
        [SerializeField] private string courierName = "Courier Outfit #150";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (150 * 40);
        [SerializeField] private int requiredDistanceMeters = 150 * 900;
