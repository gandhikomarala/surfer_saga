namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #170
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_170", menuName = "MetroRush/Cosmetics/Skin #170")]
    public class CyberSkinCatalog_170 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_170";
        [SerializeField] private string courierName = "Courier Outfit #170";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (170 * 40);
        [SerializeField] private int requiredDistanceMeters = 170 * 900;
