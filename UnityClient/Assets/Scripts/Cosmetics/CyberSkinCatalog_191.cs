namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #191
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_191", menuName = "MetroRush/Cosmetics/Skin #191")]
    public class CyberSkinCatalog_191 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_191";
        [SerializeField] private string courierName = "Courier Outfit #191";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (191 * 40);
        [SerializeField] private int requiredDistanceMeters = 191 * 900;
