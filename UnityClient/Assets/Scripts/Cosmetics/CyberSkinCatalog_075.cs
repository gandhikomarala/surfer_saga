namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #075
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_075", menuName = "MetroRush/Cosmetics/Skin #075")]
    public class CyberSkinCatalog_075 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_075";
        [SerializeField] private string courierName = "Courier Outfit #075";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (75 * 40);
        [SerializeField] private int requiredDistanceMeters = 75 * 900;
