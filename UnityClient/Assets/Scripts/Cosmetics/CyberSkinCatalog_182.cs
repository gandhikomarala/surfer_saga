namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #182
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_182", menuName = "MetroRush/Cosmetics/Skin #182")]
    public class CyberSkinCatalog_182 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_182";
        [SerializeField] private string courierName = "Courier Outfit #182";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (182 * 40);
        [SerializeField] private int requiredDistanceMeters = 182 * 900;
