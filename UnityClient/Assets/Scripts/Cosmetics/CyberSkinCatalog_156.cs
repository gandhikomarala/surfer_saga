namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #156
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_156", menuName = "MetroRush/Cosmetics/Skin #156")]
    public class CyberSkinCatalog_156 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_156";
        [SerializeField] private string courierName = "Courier Outfit #156";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (156 * 40);
        [SerializeField] private int requiredDistanceMeters = 156 * 900;
