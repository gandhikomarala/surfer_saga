namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #024
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_024", menuName = "MetroRush/Cosmetics/Skin #024")]
    public class CyberSkinCatalog_024 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_024";
        [SerializeField] private string courierName = "Courier Outfit #024";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (24 * 40);
        [SerializeField] private int requiredDistanceMeters = 24 * 900;
