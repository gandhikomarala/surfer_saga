namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #057
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_057", menuName = "MetroRush/Cosmetics/Skin #057")]
    public class CyberSkinCatalog_057 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_057";
        [SerializeField] private string courierName = "Courier Outfit #057";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (57 * 40);
        [SerializeField] private int requiredDistanceMeters = 57 * 900;
