namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #073
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_073", menuName = "MetroRush/Cosmetics/Skin #073")]
    public class CyberSkinCatalog_073 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_073";
        [SerializeField] private string courierName = "Courier Outfit #073";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (73 * 40);
        [SerializeField] private int requiredDistanceMeters = 73 * 900;
