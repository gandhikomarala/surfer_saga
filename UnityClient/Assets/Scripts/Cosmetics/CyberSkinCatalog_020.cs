namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #020
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_020", menuName = "MetroRush/Cosmetics/Skin #020")]
    public class CyberSkinCatalog_020 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_020";
        [SerializeField] private string courierName = "Courier Outfit #020";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (20 * 40);
        [SerializeField] private int requiredDistanceMeters = 20 * 900;
