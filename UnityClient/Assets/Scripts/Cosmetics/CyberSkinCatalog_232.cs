namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #232
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_232", menuName = "MetroRush/Cosmetics/Skin #232")]
    public class CyberSkinCatalog_232 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_232";
        [SerializeField] private string courierName = "Courier Outfit #232";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (232 * 40);
        [SerializeField] private int requiredDistanceMeters = 232 * 900;
