namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #066
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_066", menuName = "MetroRush/Cosmetics/Skin #066")]
    public class CyberSkinCatalog_066 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_066";
        [SerializeField] private string courierName = "Courier Outfit #066";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (66 * 40);
        [SerializeField] private int requiredDistanceMeters = 66 * 900;
