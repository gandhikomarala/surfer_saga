namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #052
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_052", menuName = "MetroRush/Cosmetics/Skin #052")]
    public class CyberSkinCatalog_052 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_052";
        [SerializeField] private string courierName = "Courier Outfit #052";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (52 * 40);
        [SerializeField] private int requiredDistanceMeters = 52 * 900;
