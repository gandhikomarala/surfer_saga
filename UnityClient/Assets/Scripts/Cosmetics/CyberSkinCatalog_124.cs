namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #124
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_124", menuName = "MetroRush/Cosmetics/Skin #124")]
    public class CyberSkinCatalog_124 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_124";
        [SerializeField] private string courierName = "Courier Outfit #124";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (124 * 40);
        [SerializeField] private int requiredDistanceMeters = 124 * 900;
