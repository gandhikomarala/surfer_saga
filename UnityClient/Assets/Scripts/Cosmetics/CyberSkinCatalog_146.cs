namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #146
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_146", menuName = "MetroRush/Cosmetics/Skin #146")]
    public class CyberSkinCatalog_146 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_146";
        [SerializeField] private string courierName = "Courier Outfit #146";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (146 * 40);
        [SerializeField] private int requiredDistanceMeters = 146 * 900;
