namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #127
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_127", menuName = "MetroRush/Cosmetics/Skin #127")]
    public class CyberSkinCatalog_127 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_127";
        [SerializeField] private string courierName = "Courier Outfit #127";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (127 * 40);
        [SerializeField] private int requiredDistanceMeters = 127 * 900;
