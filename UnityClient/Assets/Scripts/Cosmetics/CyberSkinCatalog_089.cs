namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #089
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_089", menuName = "MetroRush/Cosmetics/Skin #089")]
    public class CyberSkinCatalog_089 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_089";
        [SerializeField] private string courierName = "Courier Outfit #089";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (89 * 40);
        [SerializeField] private int requiredDistanceMeters = 89 * 900;
