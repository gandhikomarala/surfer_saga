namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #241
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_241", menuName = "MetroRush/Cosmetics/Skin #241")]
    public class CyberSkinCatalog_241 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_241";
        [SerializeField] private string courierName = "Courier Outfit #241";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (241 * 40);
        [SerializeField] private int requiredDistanceMeters = 241 * 900;
