namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #183
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_183", menuName = "MetroRush/Cosmetics/Skin #183")]
    public class CyberSkinCatalog_183 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_183";
        [SerializeField] private string courierName = "Courier Outfit #183";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (183 * 40);
        [SerializeField] private int requiredDistanceMeters = 183 * 900;
