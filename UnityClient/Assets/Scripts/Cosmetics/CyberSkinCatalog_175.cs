namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #175
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_175", menuName = "MetroRush/Cosmetics/Skin #175")]
    public class CyberSkinCatalog_175 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_175";
        [SerializeField] private string courierName = "Courier Outfit #175";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (175 * 40);
        [SerializeField] private int requiredDistanceMeters = 175 * 900;
