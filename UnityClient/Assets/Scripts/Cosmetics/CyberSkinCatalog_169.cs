namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #169
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_169", menuName = "MetroRush/Cosmetics/Skin #169")]
    public class CyberSkinCatalog_169 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_169";
        [SerializeField] private string courierName = "Courier Outfit #169";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (169 * 40);
        [SerializeField] private int requiredDistanceMeters = 169 * 900;
