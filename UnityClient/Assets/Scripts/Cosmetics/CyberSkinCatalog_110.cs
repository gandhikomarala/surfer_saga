namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #110
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_110", menuName = "MetroRush/Cosmetics/Skin #110")]
    public class CyberSkinCatalog_110 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_110";
        [SerializeField] private string courierName = "Courier Outfit #110";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (110 * 40);
        [SerializeField] private int requiredDistanceMeters = 110 * 900;
