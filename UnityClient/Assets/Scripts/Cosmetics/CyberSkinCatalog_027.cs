namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #027
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_027", menuName = "MetroRush/Cosmetics/Skin #027")]
    public class CyberSkinCatalog_027 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_027";
        [SerializeField] private string courierName = "Courier Outfit #027";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (27 * 40);
        [SerializeField] private int requiredDistanceMeters = 27 * 900;
