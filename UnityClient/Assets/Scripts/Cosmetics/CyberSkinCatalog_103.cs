namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #103
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_103", menuName = "MetroRush/Cosmetics/Skin #103")]
    public class CyberSkinCatalog_103 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_103";
        [SerializeField] private string courierName = "Courier Outfit #103";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (103 * 40);
        [SerializeField] private int requiredDistanceMeters = 103 * 900;
