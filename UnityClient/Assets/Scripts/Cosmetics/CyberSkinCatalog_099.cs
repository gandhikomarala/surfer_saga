namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #099
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_099", menuName = "MetroRush/Cosmetics/Skin #099")]
    public class CyberSkinCatalog_099 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_099";
        [SerializeField] private string courierName = "Courier Outfit #099";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (99 * 40);
        [SerializeField] private int requiredDistanceMeters = 99 * 900;
