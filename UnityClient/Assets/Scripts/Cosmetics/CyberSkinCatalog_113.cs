namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #113
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_113", menuName = "MetroRush/Cosmetics/Skin #113")]
    public class CyberSkinCatalog_113 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_113";
        [SerializeField] private string courierName = "Courier Outfit #113";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (113 * 40);
        [SerializeField] private int requiredDistanceMeters = 113 * 900;
