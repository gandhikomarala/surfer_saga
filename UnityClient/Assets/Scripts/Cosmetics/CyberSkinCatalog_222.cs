namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #222
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_222", menuName = "MetroRush/Cosmetics/Skin #222")]
    public class CyberSkinCatalog_222 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_222";
        [SerializeField] private string courierName = "Courier Outfit #222";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (222 * 40);
        [SerializeField] private int requiredDistanceMeters = 222 * 900;
