namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #141
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_141", menuName = "MetroRush/Cosmetics/Skin #141")]
    public class CyberSkinCatalog_141 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_141";
        [SerializeField] private string courierName = "Courier Outfit #141";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (141 * 40);
        [SerializeField] private int requiredDistanceMeters = 141 * 900;
