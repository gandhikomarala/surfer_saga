namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #213
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_213", menuName = "MetroRush/Cosmetics/Skin #213")]
    public class CyberSkinCatalog_213 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_213";
        [SerializeField] private string courierName = "Courier Outfit #213";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (213 * 40);
        [SerializeField] private int requiredDistanceMeters = 213 * 900;
