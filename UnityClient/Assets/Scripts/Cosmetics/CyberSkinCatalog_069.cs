namespace MetroRush.Cosmetics
{
    ...
    /// <summary>
    /// Cyberpunk Courier Skin & Neon Trail Definition #069
    /// Controls holographic visor shaders, particle exhaust colors, and unlock milestones.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberSkinCatalog_069", menuName = "MetroRush/Cosmetics/Skin #069")]
    public class CyberSkinCatalog_069 : ScriptableObject
    {
        public enum SkinRarity { Standard, Enhanced, Quantum, CyberLegend }

        [Header("Skin Metadata")]
        [SerializeField] private string skinId = "CYBER_SKIN_069";
        [SerializeField] private string courierName = "Courier Outfit #069";
        ...
        [SerializeField] private int requiredEnergyTokens = 600 + (69 * 40);
        [SerializeField] private int requiredDistanceMeters = 69 * 900;
